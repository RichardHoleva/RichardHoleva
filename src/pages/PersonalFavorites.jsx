...
export default function PersonalFavorites() {
  ...
  const handleSubmit = (e) => {
    ...
    const newDish = {
      ...
      ...formData,
      imageUrl: formData.imageUrl || 'https://placehold.co/600x400?text=No+Image' // Default placeholder
    };

    let updatedDishes;
    if (editDish) {
      updatedDishes = dishes.map(dish => dish.id === editDish.id ? newDish : dish);
      // Close both popups if we're editing
      setShowDetails(null);
    } else {
        ...
        <div className="popup" onClick={handleCloseDetails}>
          <div className="popup-content details-view" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="popup-details">
              ...
              <div className="dish-actions">
                <button className="edit-btn" onClick={() => handleEdit(showDetails)}>Update</button>
